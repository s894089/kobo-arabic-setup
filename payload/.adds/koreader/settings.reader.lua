...
return {
    ...
    ["bookshelf_hero_regions"] = {
        ["author"] = {
            ["alignment"] = "left",
            ["bold"] = false,
            ["font_face"] = "Caveat-Regular.ttf",
            ["font_size"] = 26,
        ...
        ["description"] = {
            ...
            ["bold"] = false,
            ["font_size"] = 16,
            ["template"] = "[if:rating]%rating · [/if]%description",
        },
        ["metadata"] = {
            ["alignment"] = "right",
            ["bold"] = true,
    ...
    ["screensaver_dir"] = "/mnt/onboard/wallpapers",
